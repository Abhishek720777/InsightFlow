...
import { Upload, BarChart3, Database, TrendingUp, Activity, CheckCircle2, FileText, LogOut } from 'lucide-react';
          ...
          <div className="card chart-container animate-fade-in delay-3">
            ...
            <ResponsiveContainer width="100%" height="85%">
              <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                />
                <Bar dataKey="uploads" fill="#2954ff" radius={[4, 4, 0, 0]} />
                <Bar dataKey="errors" fill="#e11d48" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        )}
